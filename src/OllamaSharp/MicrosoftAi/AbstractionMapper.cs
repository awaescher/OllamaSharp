...
internal static class AbstractionMapper
{
	...
	/// <param name="ollamaMessages">The response ollama messages to build the AI contents. This has to be a separate argument because there might be multiple messages return(Function Call, Assistant, Function Call Result).</param>
